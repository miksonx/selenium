pipeline {
    ...
    stages {
        ...
        stage ('Build application') {
            steps {
                sh 'mvn -Dmaven.test.failure.ignore=true org.owasp:dependency-check-maven:5.3.0:purge -Dformat=XML -DoutputDirectory=target/dependency-check-report.xml cobertura:cobertura -Dcobertura.aggregate=true -Dcobertura.report.format=xml package' 
            }
		}
